...
declare global {
  ...
  const S: typeof import('../src/composables/authorization')['S']
  const STORAGE_AUTHORIZE_KEY: typeof import('../src/composables/authorization')['STORAGE_AUTHORIZE_KEY']
  const STORAGE_USER_ID_KEY: typeof import('../src/composables/authorization')['STORAGE_USER_ID_KEY']
  ...
  const use: typeof import('../src/composables/authorization')['use']
  ...
  const useUserID: typeof import('../src/composables/authorization')['useUserID']
  ...
  const useWebSocketStore: typeof import('../src/stores/websocket')['useWebSocketStore']
